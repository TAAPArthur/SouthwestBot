...
class Records:
    ...
    def saveUpcomingFlight(self,userID,flight):
        ...
        self.cur.execute(query,(userID,flight.confirmationNumber,flight.flightNumber, flight.departureTime.strftime("%Y-%m-%d %H:%M:%S"),flight.arrivalTime.strftime("%Y-%m-%d %H:%M:%S"), flight.title,flight.origin,flight.dest,flight.startDate,flight.endDate,flight.price))
